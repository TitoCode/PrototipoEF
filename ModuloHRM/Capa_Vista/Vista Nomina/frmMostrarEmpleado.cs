...
namespace Capa_Vista.Vista_Reclutamiento
{
    public partial class frmMostrarEmpleado : Form
    {
        ...
        int Estado = 1;
        clsControladorNomina Cont_R = new clsControladorNomina();
        ...
        public void funcNombresParametros()
        {
            ...
            dgvMostrarEmpleados.Columns[1].HeaderText = "Primer Nombre";
            dgvMostrarEmpleados.Columns[2].HeaderText = "Segundo Nombre";
            dgvMostrarEmpleados.Columns[3].HeaderText = "Primer Apellido";
            dgvMostrarEmpleados.Columns[4].HeaderText = "Segundo Apellido";
            dgvMostrarEmpleados.Columns[5].HeaderText = "Puesto";
            dgvMostrarEmpleados.Columns[6].HeaderText = "Departamento";
        }
        ...
        public void funcNombresEncabezados()
        {
            ...
            dgvMostrarEmpleados.Columns[7].HeaderText = "Email";
            dgvMostrarEmpleados.Columns[8].HeaderText = "Telefono";
