...
namespace Capa_Controlador.Controlador_Nomina
{
    public class clsControladorNomina
    {
        ...
        {
            OdbcDataAdapter dt = Consulta.funcTablaEmpleado(Estado);
        ...
        {
            OdbcDataAdapter dt = Consulta.funcFiltradoIdEmpleado(Parametro, Estado);
            DataTable table = new DataTable();
            dt.Fill(table);
            return table;
        }
        ...
        {
            OdbcDataAdapter dt = Consulta.funcFiltradoNombreEmpleado(Parametro, Estado);
            DataTable table = new DataTable();
            dt.Fill(table);
            return table;
        }
        ...
        {
            OdbcDataAdapter dt = Consulta.funcFiltradoApellidoEmpleado(Parametro, Estado);
            DataTable table = new DataTable();
            dt.Fill(table);
            return table;
        }
        ...
        {
            OdbcDataAdapter dt = Consulta.funcFiltradoPuestoEmpleado(Parametro, Estado);
            DataTable table = new DataTable();
            dt.Fill(table);
            return table;
        }
        ...
        {
            OdbcDataAdapter dt = Consulta.funcFiltradoDepartamentoEmpleado(Parametro, Estado);
            DataTable table = new DataTable();
            dt.Fill(table);
            return table;
        }
